        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('recipient.update', $data->id) }}" method="POST">
                        @csrf @method('PUT')
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="percentage" class="form-control" placeholder="Persentase" value="{{ $data->percentage }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio radio-primary">
                                <input type="radio" name="is_active" id="radio1" value="1" {{ $data->is_active == '1' ? 'checked' : '' }}>
                                <label for="radio1">
                                    Aktif
                                </label>
                            </div>
                            <div class="radio radio-primary">
                                <input type="radio" name="is_active" id="radio2" value="0" {{ $data->is_active == '0' ? 'checked' : '' }}>
                                <label for="radio2">
                                    Non-aktif
                                </label>
                            </div>
