                    ...
                    <form action="{{ route('product.update', $data->id) }}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="price_basic" class="form-control" value="{{ $data->price_basic }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="" class="col-form-label">Harga Jual</label>
                                <input type="number" name="price_sell" class="form-control" value="{{ $data->price_sell }}">
                            </div>
                        </div>
