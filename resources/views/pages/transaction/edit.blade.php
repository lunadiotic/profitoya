                    ...
                    <form action="{{ route('transaction.update', $data->id) }}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="village_id" id="" class="form-control search" data-toggle="select2">
                                    <option value="{{ $data->village_id }}" selected>{{ $data->village->title }}</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <select name="product_id" id="" class="form-control">
                                    @foreach ($product as $key => $value)
                                        <option value="{{ $key }}" {{ $data->product_id == $key ? 'selected' : ''}}>{{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="qty_sold" class="form-control" value="{{ $data->qty_sold }}" required>
                            </div>
                            <div class="form-group col-md-6">
