...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        <meta charset="utf-8" />
        <title>{{ isset($title) ? $title : config('app.name') }} | Profit Share Report</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="A simple notes for profit" name="description" />
            ...
            <div class="content-page">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                2017 - <script>document.write(new Date().getFullYear())</script> &copy; Profitoya by <a href="https://idstack.net">IDStack</a>
                            </div>
                            <div class="col-md-6">
